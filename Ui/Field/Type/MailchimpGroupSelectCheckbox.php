...
class MailchimpGroupSelectCheckbox extends MailchimpGroupSelect
{
    const MIN_OPTIONS = Type\MailchimpGroupSelectCheckbox::MIN_OPTIONS;
    const MAX_OPTIONS = Type\MailchimpGroupSelectCheckbox::MAX_OPTIONS;
    const MIN_OPTIONS_ERROR_TEXT = Type\MailchimpGroupSelectCheckbox::MIN_OPTIONS_ERROR_TEXT;
    const MAX_OPTIONS_ERROR_TEXT = Type\MailchimpGroupSelectCheckbox::MAX_OPTIONS_ERROR_TEXT;
    const IS_INTERNAL_ELEMENTS_INLINE = Type\MailchimpGroupSelectCheckbox::IS_INTERNAL_ELEMENTS_INLINE;
