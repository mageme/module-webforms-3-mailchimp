...
class MailchimpGroupSelectCheckbox extends AbstractMailchimpGroup
{
    /**
     * Attributes
     */
     ...
     * @return $this
     */
    public function setMinOptions(int $minOptions): MailchimpGroupSelectCheckbox
    {
     ...
     * @return $this
     */
    public function setMaxOptions(int $maxOptions): MailchimpGroupSelectCheckbox
    {
     ...
     * @return $this
     */
    public function setMinOptionsErrorText(string $minOptionsErrorText): MailchimpGroupSelectCheckbox
    {
     ...
     * @return $this
     */
    public function setMaxOptionsErrorText(string $maxOptionsErrorText): MailchimpGroupSelectCheckbox
    {
     ...
     * @return $this
     */
    public function setIsInternalElementsInline(bool $isInternalElementsInline): MailchimpGroupSelectCheckbox
    {
    ...
    public function getPostErrors(array $postData, bool $logicVisibility, array $config = []): array
    {
        ...
        if ($this->getMinOptions()) {
            if (!$this->_validatePostMinOptions($postData)) {
                ...
                $errors[] = $errorMsg ?: __('Please check at least %1 options', $this->getMinOptions());
            }
        }
        ...
        if ($this->getMaxOptions()) {
            if (!$this->_validatePostMaxOptions($postData)) {
                ...
                $errors[] = $errorMsg ?: __('Please check not more than %1', $this->getMaxOptions());
            }
        }
        return $errors;
    }
